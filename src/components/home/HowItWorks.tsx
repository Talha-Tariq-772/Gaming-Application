const STEPS = [
  ...
  {
    label: "Confirm",
    description: "Tap “I have made the payment” to confirm your order.",
  },
  {
    label: "Get Access",
    description: "Once confirmed — typically 1–2 hours — your order is ready.",
  },
];
          ...
          {STEPS.map((step, i) => (
            <li key={step.label} className="flex flex-col gap-3">
              ...
              {/* Barlow, not the display face — a label, not display type. See
                  ...
                  4-column grid's ~300px columns for the longest label,
